...
declare namespace Cypress {
    ...
    import { User, BankAccount, Like, Comment, Transaction, BankTransfer, Contact } from '../src/models'
    ...
    interface Chainable {
         ...
         */
        task(event: 'filter:database', arg: dbQueryArg, options?: Partial<Loggable & Timeoutable>): Chainable<any[]>
         ...
         */
        writeVerboseReport(specFile: string, testTitle: string, testState: string, testError: any): Chainable<any>
    }
}
